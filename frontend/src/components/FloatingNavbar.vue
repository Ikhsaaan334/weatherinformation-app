...
const navItems = computed(() =>
    [
        { name: 'Dashboard', to: '/dashboard', icon: 'dashboard', active: route.name === 'dashboard', show: true },
        { name: 'Cities', to: '/cities', icon: 'location_city', active: String(route.name).startsWith('cities'), show: true },
        { name: 'Users', to: '/admin/users', icon: 'group', active: String(route.name).startsWith('admin'), show: auth.isAdmin },
        { name: 'Profile', to: '/profile', icon: 'person', active: route.name === 'profile.edit', show: true },
    ...
    >
        <div class="flex flex-col space-y-4">
            ...
            >
                ...
                <span v-show="isHovered" class="font-medium whitespace-nowrap overflow-hidden">
                    {{ item.name }}
                </span>
            </RouterLink>
            ...
            <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                >
                    ...
                    <span v-show="isHovered" class="font-medium whitespace-nowrap">Logout</span>
                </button>
            </div>
        </div>
    </div>
